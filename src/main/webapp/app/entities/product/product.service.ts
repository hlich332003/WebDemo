...
export class ProductService {
  ...
  toggleFeatured(id: number): Observable<EntityResponseType> {
    return this.http.patch<IProduct>(`${this.resourceUrl}/${id}/toggle-featured`, null, { observe: 'response' });
  }

  getFeaturedProducts(): Observable<EntityArrayResponseType> {
    return this.http.get<IProduct[]>(`${this.resourceUrl}/featured`, { observe: 'response' });
  }
  ...
  addProductToCollectionIfMissing<Type extends Pick<IProduct, 'id'> & Record<string, unknown>>(
