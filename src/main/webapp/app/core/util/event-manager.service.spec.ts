...
describe('Event Manager tests', () => {
  ...
  describe('EventManager', () => {
    ...
    it('should not fail when nosubscriber and broadcasting', inject(
      [EventManager],
    ...
    it('should create an observable and callback when broadcasted EventWithContent', inject(
      ...
      (eventManager: EventManager) => {
        ...
        eventManager.subscribe(
          'modifier',
          (event: EventWithContent<unknown> | string) =>
            (receivedEvent = event),
        );
    ...
    it('should create an observable and callback when broadcasted string', inject(
      [EventManager],
      (eventManager: EventManager) => {
        // GIVEN
        eventManager.subscribe(
    ...
    it('should subscribe to multiple events', inject(
      [EventManager],
      (eventManager: EventManager) => {
        // GIVEN
        eventManager.subscribe(
