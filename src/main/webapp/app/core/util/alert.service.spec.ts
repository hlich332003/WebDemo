...
describe('Alert service test', () => {
  describe('Alert Service Test', () => {
    ...
    it('should produce a proper alert object and fetch it', inject(
      [AlertService],
    ...
    it('should produce an alert object with correct id', inject(
      [AlertService],
      (service: AlertService) => {
    ...
    it('should close an alert correctly', inject(
      [AlertService],
      (service: AlertService) => {
    ...
    it('should close an alert on timeout correctly', inject(
      [AlertService],
      (service: AlertService) => {
        service.addAlert({ type: 'info', message: 'Hello Jhipster info' });
    ...
    it('should produce a scoped alert', inject(
      [AlertService],
      (service: AlertService) => {
        expect(
          service.addAlert(
    ...
    it('should produce a success message', inject(
      [AlertService],
      (service: AlertService) => {
        expect(
          service.addAlert({ type: 'success', message: 'Hello Jhipster' }),
        ).toEqual(
          expect.objectContaining({
            type: 'success',
            message: 'Hello Jhipster',
    ...
    it('should produce a success message with custom position', inject(
      [AlertService],
      (service: AlertService) => {
        expect(
          service.addAlert({
    ...
    it('should produce a error message', inject(
      [AlertService],
      (service: AlertService) => {
        expect(
          service.addAlert({ type: 'danger', message: 'Hello Jhipster' }),
        ).toEqual(
          expect.objectContaining({
            type: 'danger',
            message: 'Hello Jhipster',
    ...
    it('should produce a warning message', inject(
      [AlertService],
      (service: AlertService) => {
        expect(
          service.addAlert({ type: 'warning', message: 'Hello Jhipster' }),
        ).toEqual(
          expect.objectContaining({
            type: 'warning',
            message: 'Hello Jhipster',
    ...
    it('should produce a info message', inject(
      [AlertService],
      (service: AlertService) => {
        expect(
          service.addAlert({ type: 'info', message: 'Hello Jhipster' }),
        ).toEqual(
          expect.objectContaining({
            type: 'info',
            message: 'Hello Jhipster',
