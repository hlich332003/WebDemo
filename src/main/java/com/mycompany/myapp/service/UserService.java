...
public class UserService {
    ...
    public User registerUser(AdminUserDTO userDTO, String password) {
        ...
        Authority userAuthority = authorityRepository
            ...
            .orElseThrow(() -> new IllegalStateException("Authority 'ROLE_USER' not found"));
    ...
    public User createUser(AdminUserDTO userDTO) {
        User user = new User();
        user.setPassword(passwordEncoder.encode(userDTO.getPhone())); // Mật khẩu mặc định là số điện thoại
        ...
        user.setActivated(true); // Người dùng do admin tạo sẽ được kích hoạt ngay
    ...
    @Transactional(readOnly = true)
    public Page<AdminUserDTO> getUsersByAuthority(String authorityName, Pageable pageable) {
        return userRepository.findAllByAuthority_Name(authorityName, pageable).map(AdminUserDTO::new);
    }
    ...
    @Transactional(readOnly = true)
    public Page<UserDTO> getPublicUsersByAuthority(String authorityName, Pageable pageable) {
        return userRepository.findAllByAuthority_Name(authorityName, pageable).map(UserDTO::new);
    }

    @Transactional(readOnly = true)
    @Cacheable(cacheNames = "usersByLogin", key = "#login")
    ...
    public Optional<User> getUserWithAuthorities() {
        return SecurityUtils.getCurrentUserLogin().flatMap(userRepository::findOneWithAuthoritiesByEmailOrPhone);
    }
